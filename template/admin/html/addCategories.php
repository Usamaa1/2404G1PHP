...
if(isset($_POST['categoryBtn']))
{
    ...
    $insertPrepare->bindParam(":categoryName",$_POST['categoryName']);
    ...
    {
      echo "<script>alert('Category Additon failed')</script>";
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="categoryName" aria-describedby="">
                    </div>
                    <button type="submit" name="categoryBtn" class="btn btn-primary">Submit</button>
                  </form>
                </div>
              </div>
