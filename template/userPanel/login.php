<?php
    ...
    if(isset($btn))
    {
        ...
        $getUserPrepare = $connect->prepare($getUserQuery);

        $getUserPrepare->bindParam(":email",$email);

        $getUserPrepare->execute();
        $user = $getUserPrepare->fetch(PDO::FETCH_ASSOC);
                        ...
                        <div class="signin-container">
                            <form name="frm-login" method="post">
                                ...
                                <p class="form-row wrap-btn">
                                    <button class="btn btn-submit btn-bold" type="submit" name="btn">sign in</button>
