...
if (isset($_POST['signup'])) {
    ...
    $insertQuery = "INSERT INTO `users`(`firstName`, `lastName`, `email`, `password`, `phoneNumber`, `country`, `city`, `zip`, `address`, `roleId`) VALUES (
    :firstName, :lastName, :email, :pass, :phoneNumber, :country, :city, :zipcode, :address, :roleId)";

    $insertPrepare = $connect->prepare($insertQuery);

        $hashPassword = password_hash($_password, PASSWORD_BCRYPT);

    $insertPrepare->bindParam(':firstName',$_firstName);
    $insertPrepare->bindParam(':lastName',$_lastName);
    $insertPrepare->bindParam(':email',$_email);
    $insertPrepare->bindParam(':pass',$hashPassword);
    $insertPrepare->bindParam(':phoneNumber',$_phoneNumber);
    $insertPrepare->bindParam(':country',$_country);
    $insertPrepare->bindParam(':city',$_city);
    $insertPrepare->bindParam(':zipcode',$_zipcode);
    $insertPrepare->bindParam(':address',$_address);
    $insertPrepare->bindValue(':roleId',2);
                        ...
                        <div class="signin-container">
                            <form name="frm-login" method="post">
                                <p class="form-row">
                                    ...
                                    <input type="text" id="fid-name" name="firstName"  class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Last Name:<span class="requite"></span></label>
                                    <input type="text" id="fid-name" name="lastName"  class="txt-input">
                                </p>
                                <p class="form-row">
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="text" id="fid-name" name="phoneNumber"  class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Country:<span class="requite"></span></label>
                                    <input type="text" id="fid-name" name="country"  class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">City:<span class="requite"></span></label>
                                    <input type="text" id="fid-name" name="city" class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Zip Code:<span class="requite"></span></label>
                                    <input type="text" id="fid-name" name="zipcode"  class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Address:<span class="requite"></span></label>
                                    <input type="text" id="fid-name" name="address"  class="txt-input">
                                </p>
                                <p class="form-row wrap-btn">
                                    <button class="btn btn-submit btn-bold" type="submit" name="signup">sign up</button>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                ...
                                <a href="#" class="btn btn-bold">Already have an account?</a>
                            </div>
                        </div>
                    </div>
