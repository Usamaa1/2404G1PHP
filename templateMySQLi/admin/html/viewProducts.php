...
<!-- SELECT products.prodId, products.prodName, products.prodPrice, products.prodCutPrice, products.prodDesc, products.prodImage, category.category_id, category.category_name FROM `products` INNER JOIN `category` ON products.categoryId = category.category_id; -->
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Product Cut Price</h6>
                                        </th>
                                        <th class="border-bottom-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['prodId'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['prodName'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['prodPrice'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['prodCutPrice'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['prodDesc'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $product['category_name'] ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><img width="100px" src="../../images/<?= $product['prodImage'] ?>" alt="" srcset=""></h6>
                                        </td>
