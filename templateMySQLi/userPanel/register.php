...
if (isset($_POST['signup'])) {
    ...
    $checkUserQuery = "SELECT * FROM `users` WHERE email = '" . mysqli_real_escape_string($connect, $_email) . "'";
    ...
    if (mysqli_num_rows($checkUserResult) > 0) {
        ...
        $insertQuery = "INSERT INTO `users` (`firstName`, `lastName`, `email`, `password`, `phoneNumber`, `country`, `city`, `zip`, `address`, `roleId`) 
                        VALUES ('$_firstName', '$_lastName', '$_email','$hashPassword', '$_phoneNumber', '$_country', '$_city', '$_zipcode', '$_address',2)";
