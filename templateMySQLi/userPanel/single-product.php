...
<body class="biolife-body">
                ...
                <div class="sumary-product single-layout">
                    <div class="media">
                        <ul class="biolife-carousel slider-for"
                            ...
                            <li><img src="../images/<?php echo $products['prodImage'] ?>" alt="" width="500"
                                    height="500"></li>
                        ...
                        <ul class="biolife-carousel slider-nav"
                            ...
                            <li><img src="assets/images/details-product/thumb_01.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_02.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_03.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_04.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_05.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_06.jpg" alt="" width="88" height="88">
                            </li>
                            <li><img src="assets/images/details-product/thumb_07.jpg" alt="" width="88" height="88">
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="product-attribute">
                        ...
                        <div class="price">
                            <ins><span class="price-amount"><span
                                        class="currencySymbol">£</span><?php echo $products['prodPrice'] ?></span></ins>
                            <del><span class="price-amount"><span
                                        class="currencySymbol">£</span><?php echo $products['prodCutPrice'] ?></span></del>
                        </div>
                ...
                <form method="post">
                    <div class="action-form">
                        <div class="quantity-box">
                            ...
                            <div class="qty-input">
                                <input id="quantity" type="text" name="qty" value="1" data-max_value="20"
                                    data-min_value="1" data-step="1">
                                <a href="#" id="qtyUp" class="qty-btn btn-up"><i class="fa fa-caret-up"
                                        aria-hidden="true"></i></a>
                                <a href="#" id="qtyDown" class="qty-btn btn-down"><i class="fa fa-caret-down"
                                        aria-hidden="true"></i></a>
                            </div>
                        </div>
    ...
    <script>
        ...
        let currentPrice = totalPriceInput.value;
        ...
        qtyUp.addEventListener('click', () => {
            ...
            // console.log(currentPrice * currentQuantity)

            currentTotalPrice = currentPrice * currentQuantity

            totalPriceInput.value = currentTotalPrice

            totalPrice.innerHTML = `£ ${currentTotalPrice}`
